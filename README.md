...
- **Səhifələmə:** müştəri menyusunda yeməklər nömrəli səhifələrlə göstərilir (səhifədə 12, ‹ 1 2 3 ›), kateqoriya tab-ları da səhifələnir ("Hamısı" sabit; telefonda 2, planşetdə 4, kompüterdə 6 kateqoriya). Axtarış/kateqoriya/allergen filtri dəyişəndə 1-ci səhifəyə qayıdır. Admin panelin Menyu və Kateqoriyalar siyahılarında da nömrəli səhifələmə var (10/20/50).
